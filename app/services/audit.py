...
def log_audit(
    ...
    Args:
        ...
        action: Aktion (u.a. run_start, run_cancel, settings_update, system_settings_update, user_login, user_update, user_block, user_unblock, user_delete, git_sync, sync_settings_update, sync_repo_config_save/delete, sync_deploy_key_generate, sync_repo_config_test, sync_clear_pipelines, sync_host_key_reset, downstream_trigger_create/delete)
